...
public class MWS460B extends BasePage {
  ...
  private WebElement btnViewSelect;
  ...
  @FindBy(xpath = "(//a/span[text()=\'Balance ID - reclassify\'])[3]")
  private WebElement linkBalanceIDReclassify;
  
  public void selectSortingOrder(final String sorting) {
    this.selectFromDropdown(this.btnSortingSelect, this.listOptions, sorting);
  }
  ...
  public void selectView(final String view) {
    this.selectFromDropdown(this.btnViewSelect, this.listOptions, view);
  }
  
  public void searchLocation(final String location) {
    WebDriverExtensions.EnterText(this.txtLocationSearch, location);
    this.txtLocationSearch.sendKeys(Keys.ENTER);
  }
  
  public void balanceIdReclassify() {
    InforGrid grid = new InforGrid(this.gridElement);
    ...
    this.linkRelated.click();
    WebDriverExtensions.waitToBeClickable(this.linkBalanceIDReclassify);
    this.linkBalanceIDReclassify.click();
    BasePage.waitForLoadingComplete();
  }
}

...
public class BasePage extends WebDriverExtensions {
  ...
  private static WebElement lblProgramShortName;
  ...
  public String getPageId() {
    BasePage.waitForLoadingComplete();
    System.out.println(BasePage.lblProgramShortName.getText());
    return BasePage.lblProgramShortName.getText();
  }
   ...
   */
  public void clickNextTillReqPanel(final String panelName) {
    BasePage.waitForLoadingComplete();
    ...
    do {
      {
        this.btnNext.click();
        BasePage.waitForLoadingComplete();
        shortPageName = BasePage.lblProgramShortName.getText();
      }

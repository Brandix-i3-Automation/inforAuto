...
import bi3.pages.mms060.MMS060E;
...
import bi3.pages.mms130.MMS130A;
import bi3.pages.mms130.MMS130E;
...
public class EndToEndMadeToOrderTest extends BaseTest {
  ...
  private MMS060E mms060e;
  
  private MMS130A mms130a;
  
  private MMS130E mms130e;
  ...
  public void Initialize() {
    ...
    MMS060E _mMS060E = new MMS060E(BaseTest.driver);
    this.mms060e = _mMS060E;
    MMS130A _mMS130A = new MMS130A(BaseTest.driver);
    this.mms130a = _mMS130A;
    MMS130E _mMS130E = new MMS130E(BaseTest.driver);
    this.mms130e = _mMS130E;
  }
  ...
  public void EndToEndMadeToOrderTest() {
    ...
    String location = "YPF001";
    String warehouse = "001";
    ...
    this.pendingPutAwayAndReclassify(newItemNumber, location, warehouse);
  }
  ...
  public moDto MOPVerification(final String warehouse, final String newItemNumber) {
    ...
    System.out.println(("Short schedule number " + shortSched));
  ...
  public void pendingPutAwayAndReclassify(final String itemNumber, final String location, final String warehouse) {
    this.homePage.GoToMWS060();
    this.mws060b.enterItemNumber(itemNumber);
    this.mws060b.changeFirstRecord();
    String pendingPutAway = this.mms060e.getPendingPutAwayValue();
    boolean _equals = pendingPutAway.equals("0");
    boolean _not = (!_equals);
    if (_not) {
      this.mms060e.closeAllTabs();
      this.homePage.GoToMWS460();
      this.mws460b.selectSortingOrder("10-Loc,Item.Lot");
      this.mws460b.selectView("F10-Warehouse, Location, Item, Lot");
      this.mws460b.setWarehouse(warehouse);
      this.mws460b.setItemNumber(itemNumber);
      this.mws460b.searchLocation(location);
      this.mws460b.processGridRow(0);
      Assert.assertTrue(this.mws460b.getFooterMessage().contains("is processed"));
      this.mws460b.closeAllTabs();
      this.homePage.GoToMWS060();
      this.mws060b.enterItemNumber(itemNumber);
      this.mws060b.changeFirstRecord();
      pendingPutAway = this.mms060e.getPendingPutAwayValue();
      Assert.assertEquals(pendingPutAway, "0");
    }
    this.mms060e.clickNext();
    this.mws460b.balanceIdReclassify();
    this.mms130a.setItemNumber(itemNumber);
    this.mms130a.setCalcMethod("1-Change status location level");
    this.mms130a.clickNext();
    this.mms130e.checkAllocatable();
    this.mms130e.clickNext();
    this.mms130a.closeAllTabs();
  }
}

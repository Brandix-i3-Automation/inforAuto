...
public class DistributionOrderFlowTest extends FnBCommons {
  ...
  public void DistributionOrderFlowTest() {
    try {
      ...
      this.pps310a.SetRecievingNo(ReceivingNo);
      ...
      this.mws410b.refreshPage();
      String RIP = this.mws410b.TakeRipValue().get(0);
      boolean _notEquals = (!Objects.equal(RIP, Integer.valueOf(1)));
      if (_notEquals) {
        Thread.sleep(2000);
        this.mws410b.goToRelatedOption("Release for Picking");
        Thread.sleep(6000);
      ...
      RIP = this.mws410b.TakeRipValue().get(0);
